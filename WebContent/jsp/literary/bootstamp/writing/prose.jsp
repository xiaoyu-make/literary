...
<input type="hidden" id="proseScanDataProse" value="${scanMyWorkProse.prose}">
<input type="hidden" id="proseScanDataDate" value="${scanMyWorkProse.date}">
